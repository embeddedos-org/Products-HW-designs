// Hardware Security Modules — parametric enclosure
// Part: eHSM-9000
//
...
//
// Render:  openscad -o enclosure.stl hardware_security_modules_enclosure.scad
...
board_w = 300.0;   // board width, mm
board_h = 200.0;   // board depth, mm
