# Hardware Security Modules — Placement and Area Check

> **Result:** FITS

| Metric | Value |
|---|---|
| Components placed | 510 |
| Components unplaced | 0 |
| Assembly-level items excluded | 1 |
| Courtyard area used | 5299.6 mm² |
| Usable board area | 58016.0 mm² |
| Courtyard utilisation | 9.1% |
