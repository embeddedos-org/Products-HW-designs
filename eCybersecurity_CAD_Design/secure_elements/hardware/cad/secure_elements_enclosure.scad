// Secure Element Modules — parametric enclosure
// Part: eSE-100
//
...
//
// Render:  openscad -o enclosure.stl secure_elements_enclosure.scad
...
board_w = 30.0;   // board width, mm
board_h = 22.0;   // board depth, mm
