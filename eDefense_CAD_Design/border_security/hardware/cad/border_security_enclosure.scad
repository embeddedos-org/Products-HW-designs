// Border Security Systems — parametric enclosure
// Part: eBRD-600
//
...
//
// Render:  openscad -o enclosure.stl border_security_enclosure.scad
...
board_w = 90.0;   // board width, mm
board_h = 60.0;   // board depth, mm
