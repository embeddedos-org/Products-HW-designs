// Embedded Vision Processing — parametric enclosure
// Part: eVIS-600
//
...
//
// Render:  openscad -o enclosure.stl vision_processing_enclosure.scad
...
board_w = 100.0;   // board width, mm
board_h = 80.0;   // board depth, mm
