# Air Traffic Management Systems — PCB Stackup

> **Board:** eATM-3000 | **Layers:** 12 | **Finished thickness:** 1.6 mm | **IPC class:** Class 2
...
| Parameter | Value |
|---|---|
| Outline | 260.0 mm x 180.0 mm |
| Finished thickness | 1.6 mm +/- 10% |
| Surface finish | ENIG with shielding cans over RF sections |
...
Rogers RO4350B RF layer over FR-4
