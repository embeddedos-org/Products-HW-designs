# Key Management Appliances — Placement and Area Check

> **Result:** FITS

| Metric | Value |
|---|---|
| Components placed | 307 |
| Components unplaced | 0 |
| Assembly-level items excluded | 1 |
| Courtyard area used | 3714.4 mm² |
| Usable board area | 43296.0 mm² |
| Courtyard utilisation | 8.6% |
