// Radiation-Tolerant Electronics — parametric enclosure
// Part: eRAD-100
//
...
//
// Render:  openscad -o enclosure.stl rad_tolerant_electronics_enclosure.scad
...
board_w = 233.0;   // board width, mm
board_h = 220.0;   // board depth, mm
