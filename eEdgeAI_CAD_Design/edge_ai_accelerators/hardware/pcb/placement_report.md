# Edge AI Accelerator Modules — Placement and Area Check

> **Result:** FITS

| Metric | Value |
|---|---|
| Components placed | 299 |
| Components unplaced | 0 |
| Assembly-level items excluded | 2 |
| Courtyard area used | 5571.7 mm² |
| Usable board area | 16206.0 mm² |
| Courtyard utilisation | 34.4% |
