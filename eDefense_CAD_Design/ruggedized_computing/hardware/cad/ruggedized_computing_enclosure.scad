// Ruggedised Computing Platforms — parametric enclosure
// Part: eRGD-2000
//
...
//
// Render:  openscad -o enclosure.stl ruggedized_computing_enclosure.scad
...
board_w = 180.0;   // board width, mm
board_h = 140.0;   // board depth, mm
