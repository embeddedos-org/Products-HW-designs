// Disaster Management Systems — parametric enclosure
// Part: eDIS-600
//
...
//
// Render:  openscad -o enclosure.stl disaster_management_enclosure.scad
...
board_w = 120.0;   // board width, mm
board_h = 90.0;   // board depth, mm
