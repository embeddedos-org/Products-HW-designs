# Neuromorphic Computing Platforms — Placement and Area Check

> **Result:** FITS

| Metric | Value |
|---|---|
| Components placed | 267 |
| Components unplaced | 0 |
| Assembly-level items excluded | 2 |
| Courtyard area used | 1403.2 mm² |
| Usable board area | 11136.0 mm² |
| Courtyard utilisation | 12.6% |
