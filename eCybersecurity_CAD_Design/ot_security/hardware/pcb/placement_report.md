# OT Security Appliances — Placement and Area Check

> **Result:** FITS

| Metric | Value |
|---|---|
| Components placed | 276 |
| Components unplaced | 0 |
| Assembly-level items excluded | 2 |
| Courtyard area used | 3829.9 mm² |
| Usable board area | 16536.0 mm² |
| Courtyard utilisation | 23.2% |
