// Edge AI Accelerator Modules — parametric enclosure
// Part: eAI-2000
//
...
//
// Render:  openscad -o enclosure.stl edge_ai_accelerators_enclosure.scad
...
board_w = 150.0;   // board width, mm
board_h = 115.0;   // board depth, mm
