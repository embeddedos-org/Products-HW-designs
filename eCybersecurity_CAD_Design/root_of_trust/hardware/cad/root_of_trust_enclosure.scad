// Hardware Root of Trust — parametric enclosure
// Part: eROT-400
//
...
//
// Render:  openscad -o enclosure.stl root_of_trust_enclosure.scad
...
board_w = 85.0;   // board width, mm
board_h = 65.0;   // board depth, mm
