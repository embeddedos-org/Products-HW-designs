# Propulsion Control Systems — Placement and Area Check

> **Result:** FITS

| Metric | Value |
|---|---|
| Components placed | 287 |
| Components unplaced | 0 |
| Assembly-level items excluded | 1 |
| Courtyard area used | 5373.3 mm² |
| Usable board area | 14976.0 mm² |
| Courtyard utilisation | 35.9% |
