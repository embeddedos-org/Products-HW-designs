// Bioelectronics Research Platforms — parametric enclosure
// Part: eBIO-500
//
...
//
// Render:  openscad -o enclosure.stl bioelectronics_enclosure.scad
...
board_w = 160.0;   // board width, mm
board_h = 120.0;   // board depth, mm
