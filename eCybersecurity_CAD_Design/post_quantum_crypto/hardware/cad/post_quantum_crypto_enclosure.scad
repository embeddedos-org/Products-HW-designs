// Post-Quantum Cryptography Accelerators — parametric enclosure
// Part: ePQC-500
//
...
//
// Render:  openscad -o enclosure.stl post_quantum_crypto_enclosure.scad
...
board_w = 140.0;   // board width, mm
board_h = 100.0;   // board depth, mm
