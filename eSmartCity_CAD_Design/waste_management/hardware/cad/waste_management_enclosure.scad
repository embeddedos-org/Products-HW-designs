// Smart Waste Management — parametric enclosure
// Part: eWM-300
//
...
//
// Render:  openscad -o enclosure.stl waste_management_enclosure.scad
...
board_w = 60.0;   // board width, mm
board_h = 45.0;   // board depth, mm
