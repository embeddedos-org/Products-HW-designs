# Maritime Defence Systems — PCB Stackup

> **Board:** eMDS-800 | **Layers:** 10 | **Finished thickness:** 1.6 mm | **IPC class:** Class 3
...
| Parameter | Value |
|---|---|
| Outline | 200.0 mm x 150.0 mm |
| Finished thickness | 1.6 mm +/- 10% |
| Surface finish | ENIG, conformal coated for marine exposure |
