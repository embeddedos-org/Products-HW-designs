# GNSS Receiver Systems — PCB Stackup

> **Board:** eGNSS-400 | **Layers:** 8 | **Finished thickness:** 1.6 mm | **IPC class:** Class 3
...
| Parameter | Value |
|---|---|
| Outline | 100.0 mm x 80.0 mm |
| Finished thickness | 1.6 mm +/- 10% |
| Surface finish | ENIG with RF shield can |
...
Continuous RF ground under antenna feed
