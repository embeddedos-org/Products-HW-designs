# Air Traffic Management Systems — Placement and Area Check

> **Result:** FITS

| Metric | Value |
|---|---|
| Components placed | 408 |
| Components unplaced | 0 |
| Assembly-level items excluded | 1 |
| Courtyard area used | 4568.4 mm² |
| Usable board area | 45056.0 mm² |
| Courtyard utilisation | 10.1% |
