// MIL-SPEC Qualification Platform — parametric enclosure
// Part: eMIL-100
//
...
//
// Render:  openscad -o enclosure.stl milspec_qualification_enclosure.scad
...
board_w = 220.0;   // board width, mm
board_h = 160.0;   // board depth, mm
