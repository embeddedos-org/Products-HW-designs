# Electronic Warfare Systems — Placement and Area Check

> **Result:** FITS

| Metric | Value |
|---|---|
| Components placed | 502 |
| Components unplaced | 0 |
| Assembly-level items excluded | 1 |
| Courtyard area used | 5517.9 mm² |
| Usable board area | 35724.0 mm² |
| Courtyard utilisation | 15.4% |
