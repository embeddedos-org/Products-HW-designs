# Bioelectronics Research Platforms — Placement and Area Check

> **Result:** FITS

| Metric | Value |
|---|---|
| Components placed | 641 |
| Components unplaced | 0 |
| Assembly-level items excluded | 1 |
| Courtyard area used | 7078.5 mm² |
| Usable board area | 18096.0 mm² |
| Courtyard utilisation | 39.1% |
