# CubeSat Systems — PCB Stackup

> **Board:** eCUBE-3U | **Layers:** 8 | **Finished thickness:** 1.6 mm | **IPC class:** Class 3
...
| Parameter | Value |
|---|---|
| Outline | 90.0 mm x 96.0 mm |
| Finished thickness | 1.6 mm +/- 10% |
| Surface finish | ENIG, staked components, conformal coated |
...
Symmetric with dedicated analogue ground pour
