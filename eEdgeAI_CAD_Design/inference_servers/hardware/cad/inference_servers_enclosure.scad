// Edge Inference Servers — parametric enclosure
// Part: eINF-4000
//
...
//
// Render:  openscad -o enclosure.stl inference_servers_enclosure.scad
...
board_w = 420.0;   // board width, mm
board_h = 300.0;   // board depth, mm
