# Speech and Audio Front Ends — Placement and Area Check

> **Result:** FITS

| Metric | Value |
|---|---|
| Components placed | 163 |
| Components unplaced | 0 |
| Assembly-level items excluded | 1 |
| Courtyard area used | 1279.6 mm² |
| Usable board area | 14526.7 mm² |
| Courtyard utilisation | 8.8% |
