#!/usr/bin/env python3
"""Duty-cycled power simulation for eSPX-300 Far-Field Voice Front End."""
...
modes = {
    "Wake-word listening (2 mics active)": (0.0135, 0.93),
    "Full array beamforming": (0.062, 0.055),
    "Streaming to host over BLE": (0.091, 0.014),
    "Model update": (0.12, 0.001),
}
BATTERY_MAH = 2000

print("=" * 62)
print("eSPX-300 Far-Field Voice Front End — Power by Mode")
print("=" * 62)
