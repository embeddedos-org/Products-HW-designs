# Digital Forensic Appliances — Placement and Area Check

> **Result:** FITS

| Metric | Value |
|---|---|
| Components placed | 347 |
| Components unplaced | 0 |
| Assembly-level items excluded | 2 |
| Courtyard area used | 3357.4 mm² |
| Usable board area | 41536.0 mm² |
| Courtyard utilisation | 8.1% |
