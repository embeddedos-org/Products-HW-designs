#!/usr/bin/env python3
"""Duty-cycled power simulation for eATP-500 Anti-Tamper Subsystem."""
...
modes = {
    "Tamper monitoring on backup cell": (4.5e-06, 0.9),
    "Mesh integrity sweep": (0.0022, 0.095),
    "Alarm evaluation": (0.018, 0.004),
    "Zeroise sequence": (0.095, 0.001),
}
BATTERY_MAH = 450

print("=" * 62)
print("eATP-500 Anti-Tamper Subsystem — Power by Mode")
print("=" * 62)
...
print(f"Battery life (2x CR2032 tamper cell): {runtime_h:,.0f} h "
