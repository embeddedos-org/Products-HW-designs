// Tamper Detection Subsystems — parametric enclosure
// Part: eTD-300
//
...
//
// Render:  openscad -o enclosure.stl tamper_detection_enclosure.scad
...
board_w = 75.0;   // board width, mm
board_h = 55.0;   // board depth, mm
