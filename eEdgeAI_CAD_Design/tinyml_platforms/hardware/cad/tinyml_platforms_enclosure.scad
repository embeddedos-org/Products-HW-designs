// TinyML Platforms — parametric enclosure
// Part: eTML-100
//
...
//
// Render:  openscad -o enclosure.stl tinyml_platforms_enclosure.scad
...
board_w = 48.0;   // board width, mm
board_h = 36.0;   // board depth, mm
